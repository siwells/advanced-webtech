...
\begin{figure}[H]
\centering
\includegraphics[width=0.5\textwidth]{images/putty_complete_levinux.png}
...
\begin{framed}
\textbf{VERY IMPORTANT} Change port=9103 to whatever port your have been assigned by the module leader. If you are not sure ask.
\end{framed}
