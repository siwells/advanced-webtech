...
\paragraph{} In the next case we download the pre-compiled Python egg then use easy\_install to install it:

\begin{lstlisting}[style=DOS]
    $ curl -L -o py_bcrypt-0.4-py2.7-linux-i686.egg https://DROPBOXLINK
    $ sudo su
