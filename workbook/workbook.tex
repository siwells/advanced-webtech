...
\label{pycrypto}
\paragraph{} PyCrypto is the Python Cryptography Toolkit and provides a range of useful tools for encyrpting and working with encrypted data in Python. You can install PyCrypto using the pip tool as follows (NB. If you haven't installed Pip yet then visit section \ref{pip} first before continuing):
