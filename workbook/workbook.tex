...
\paragraph{} Make yourself a similar directory hierachy to that shown above then download Bootstrap from \url{the bootstrap site} and unpack it, e.g.

\begin{lstlisting}[style=DOS]
    $ curl -o bootstrap.zip http://bootstrap.com/
    $ unzip bootstrap.zip
\end{lstlisting}
