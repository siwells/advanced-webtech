...
\paragraph{} Notice that the file is being saved in a sub-directory called `incoming' that is in the same directory as our Python-Flask web-app. Look in there for the new file. Perhaps combine this file upload facility with the image display example that we saw in section \ref{static}.
