...
\paragraph{} You can install py-bcrypt using the pip tool as follows (NB. If you haven't installed Pip yet then visit section \ref{pip} first before continuing):
...
\begin{table}
    ...
    Search apt-cache search pattern	    & tce-ab \\
